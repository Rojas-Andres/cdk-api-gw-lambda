...
def generate_fake_log_event(timestamp_ms):
    ...
    request_time = datetime.fromtimestamp(timestamp_ms / 1000).strftime("%d/%b/%Y:%H:%M:%S +0000")
...
def generate_fake_data_message(log_stream_id, num_events=1, base_timestamp=None):
    ...
    for i in range(num_events):
        ...
        log_events.append(generate_fake_log_event(timestamp_ms))
...
def main():
    ...
    num_messages = 30  # Number of DATA_MESSAGE objects
    ...
    print(f"\nSummary:")
    print(f"  - Data messages: {num_messages}")
